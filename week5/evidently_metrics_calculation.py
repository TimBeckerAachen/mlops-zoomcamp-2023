...
def calculate_metrics_postgresql(curr, i):
	...
	print(i, prediction_drift, num_drifted_columns, share_missing_values, column_quantile)

	curr.execute(
		"insert into homework_metrics(timestamp, prediction_drift, num_drifted_columns, column_quantile, "
		"share_missing_values) values (%s, %s, %s, %s, %s)",
